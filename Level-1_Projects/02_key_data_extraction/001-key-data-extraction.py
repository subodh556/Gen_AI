...
class Person(BaseModel):
    ...
    lastname: Optional[str] = Field(default=None,description="The country of the person if known")
...
chain = prompt | chatm.with_structured_output(schema=Person)
...
chain = prompt | chatm.with_structured_output(schema=Data)
